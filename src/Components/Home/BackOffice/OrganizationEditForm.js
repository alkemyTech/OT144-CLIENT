...
const validation = (values) => {
	const errors = {}
	const regexUrl =
		/^(http:\/\/www\.|https:\/\/www\.|http:\/\/|https:\/\/|www\.)?[-a-z0-9]+\.(?:com|gov|org|net|edu|biz)/

	if (
		values.shortDescription === 'Descripción breve*' ||
						...
						<form onSubmit={props.handleSubmit}>
							...
							<div className="logo-container">
								...
								<input
									...
									onChange={() => handleChangeLogo(props)}
									accept=".png, .jpg"
									required
								/>
							</div>
							...
							<textarea
								...
								onChange={props.handleChange}
								placeholder="Ingresá una descripción detallada*"
							...
							<div className="div-error">
								{props.touched.socialNetworkLinks &&
									props.errors.socialNetworkLinks}
							</div>
