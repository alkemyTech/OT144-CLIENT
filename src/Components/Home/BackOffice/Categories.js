                        ...
                        {categories.map(category => {
                            return (
                                <tr key={category.id}>
                                    ...
                                    <td>
                                        <button className="btnUpdateTable" type="button" onClick={() => handleClickUpdate(category.id)}>Editar</button>
                                        <button className="btnDeleteTable" type="button" onClick={() => handleClickDelete(category.id)}>Eliminar</button>
                                    </td>
                                </tr>
                            )
                        })}
