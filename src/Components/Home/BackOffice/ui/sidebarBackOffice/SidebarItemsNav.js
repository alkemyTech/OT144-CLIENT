    ...
    <div className='SideBarMenuItem'>
          ...
          >
            <div className={classNames('itemContent', isOpen ? '' : ' collapsed')}>
              <div className='icon'>
                <img className={classNames( isOpen ? " img-icon" : " img-icon-d")} src={backoffice} alt="backoffice"/>
              </div>
          ...
          >
            <div className={classNames('itemContent', isOpen ? '' : ' collapsed')}>
              <div className='icon'>
                <img className={classNames( isOpen ? " img-icon" : " img-icon-d")} src={organization} alt="organization"/>
              </div>
          ...
          >
            <div className={classNames('itemContent', isOpen ? '' : ' collapsed')}>
              ...
              {
                !isOpen?<div className='tooltip'>EDITAR ORGANIZACIÓN HOME</div> : ''
              }
            </div>
          </NavLink>
          <NavLink 
          ...
          >
            <div className={classNames('itemContent', isOpen ? '' : ' collapsed')}>
              <div className='icon'>
                <img className={classNames( isOpen ? " img-icon" : " img-icon-d")} src={slides} alt="slides"/>
              </div>
          ...
          >
            <div className={classNames('itemContent', isOpen ? '' : ' collapsed')}>
              ...
              {
                !isOpen?<div className='tooltip'>EDITAR DIAPOSITIVAS ACCIÓN</div> : ''
              }
            </div>
          </NavLink>
          <NavLink 
          ...
          >
            <div className={classNames('itemContent', isOpen ? '' : ' collapsed')}>
              <div className='icon'>
                <img className={classNames( isOpen ? " img-icon" : " img-icon-d")} src={user} alt="user"/>
              </div>
          ...
          >
            <div className={classNames('itemContent', isOpen ? '' : ' collapsed')}>
              <div className='icon'>
                <img className={classNames( isOpen ? " img-icon" : " img-icon-d")} src={members} alt="members"/>
              </div>
          ...
          >
            <div className={classNames('itemContent', isOpen ? '' : ' collapsed')}>
              <div className='icon'>
                <img className={classNames( isOpen ? " img-icon" : " img-icon-d")} src={categories} alt="categories"/>
              </div>
          ...
          >
            <div className={classNames('itemContent', isOpen ? '' : ' collapsed')}>
              <div className='icon'>
                <img className={classNames( isOpen ? " img-icon" : " img-icon-d")} src={news} alt="news"/>
              </div>
              <span className='label'>Categorias</span>
              {
                !isOpen?<div className='tooltip'>CATEGORIAS</div> : ''
